...
def test_movement():
    ...
    perception_radius = 3
    approach_speed = 0.5
    ants.movement(perception_radius, approach_speed) # calls the movement function with the parameters perception_radius and approach_speed
...
def test_perception():
    ...
    assert perception_function == expected_results # checking if the results from the function are equal to the expected results
