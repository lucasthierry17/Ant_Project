...
class Ants(pygame.sprite.Sprite):
    ...
    def __init__(self, nest, pheromones):
        ...
        Parameters:
        - nest (tuple): Tuple representing the starting coordinates of the ant.
    ...
    def update_with_food(self, randDir, random_scale, scaled_pos):
        """Update the ant's state when it has food."""
        global max_distance
    ...
    def update_without_food(self, randDir, scaled_pos):
        """Update the ant's state when it doesn't have food."""
    ...
    def update_with_food_sources(self, scaled_pos):
        """Update the ant's state when there are food sources nearby."""
...
class Pheromones:
    ...
    def __init__(self, bigSize):
        ...
        Parameters:
        - bigSize (tuple): Tuple representing the size of the entire grid in the simulation.
        """
    ...
    def update(self):
        ...
        self.img_array = self.img_array.clip(0, 255)  # Clip pheromone values to stay within the color range
